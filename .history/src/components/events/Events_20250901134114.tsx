              ...
              : paginatedEvents.length === 0
                ...
                : paginatedEvents.map((evt) => {
                  ...
                  return (
                    ...
                    >
                      <Card className="px-0 py-0 rounded-3xl overflow-hidden border border-indigo-100 shadow-md transition-all duration-300 hover:shadow-indigo-hover">

                        {/* Inner Background Layer */}
                        <div className={`px-0 py-0 rounded-3xl overflow-hidden border border-indigo-100 shadow-md transition-all duration-300 hover:shadow-indigo-hover ${getCardStatusColor(evt.eventStatus)} ${buttonHovered ? 'bg-black/20' : ''}`}>
                          ...
                          <CardContent className="px-6 pb-6 space-y-5">
                            ...
                            {/* Hover Buttons */}
                            <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10" onMouseEnter={() => setButtonHovered(true)} onMouseLeave={() => setButtonHovered(false)}>
                              <Button
                                size="sm"
                                variant="outline"
                                onClick={(e) => {
