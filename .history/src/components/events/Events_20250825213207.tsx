...
// Content colors based on status for better visual experience
const contentStatusColors: Record<VEvent['eventStatus'], {
  title: string;
  description: string;
  dateLabel: string;
  dateValue: string;
  ...
  upcoming: {
    title: "text-indigo-900", // Vibrant color for better visibility
    description: "text-gray-800", // Lighter shade for readability
    dateLabel: "text-gray-600", // Distinct color for contrast
    dateValue: "text-indigo-700 font-semibold", // Emphasis on date values
    progressText: "text-gray-600", // Clear color for progress text
    progressPercent: "text-gray-500", // Complementary color for percentage
    progressBar: "from-indigo-300 to-indigo-500", // Softer gradient for progress bar
    allDayText: "text-indigo-400 italic", // Softer tone for all-day events
    divider: "border-gray-200" // Softer border color
  },
  inProgress: {
    title: "text-orange-900",
    description: "text-orange-700",
    dateLabel: "text-orange-500",
    dateValue: "text-orange-800 font-semibold",
    progressText: "text-orange-600",
    progressPercent: "text-orange-500",
    progressBar: "from-amber-400 to-orange-600",
    allDayText: "text-orange-400 italic",
    divider: "border-orange-200"
  },
  expired: {
    title: "text-slate-900",
    description: "text-slate-600",
    dateLabel: "text-slate-500",
    dateValue: "text-slate-700 font-semibold",
    progressText: "text-slate-600",
    progressPercent: "text-slate-500",
    progressBar: "from-red-400 to-slate-600",
    allDayText: "text-slate-400 italic",
    divider: "border-slate-300"
  },
  completed: {
    title: "text-teal-900",
    description: "text-teal-700",
    dateLabel: "text-teal-500",
    dateValue: "text-teal-800 font-semibold",
    progressText: "text-teal-600",
    progressPercent: "text-teal-500",
    progressBar: "from-green-400 to-teal-600",
    allDayText: "text-teal-400 italic",
    divider: "border-teal-200"
  }
};

// Helper function to get content status colors with fallback
const getContentStatusColor = (status: VEvent['eventStatus']) => {
  return contentStatusColors[status] || {
    title: "text-gray-900",
    description: "text-gray-700",
    dateLabel: "text-gray-500",
    dateValue: "text-gray-800 font-semibold",
    progressText: "text-gray-600",
    progressPercent: "text-gray-500",
    progressBar: "from-gray-400 to-gray-600",
    allDayText: "text-gray-400 italic",
...
// Softer card background colors with high readability
const cardStatusColors: Record<VEvent['eventStatus'], string> = {
  upcoming: "bg-indigo-100 text-indigo-900",    // soft indigo background, dark text
  inProgress: "bg-amber-100 text-amber-900",   // soft amber background
  expired: "bg-gray-200 text-gray-800",        // subtle gray for expired
  completed: "bg-emerald-100 text-emerald-900" // fresh green background
};

// Content colors tuned for contrast against the above
const contentStatusColors: Record<VEvent['eventStatus'], {
  title: string;
  description: string;
  dateLabel: string;
  ...
  upcoming: {
    title: "text-indigo-900 font-semibold",
    description: "text-gray-700",
    dateLabel: "text-indigo-600",
    dateValue: "text-indigo-800 font-semibold",
    progressText: "text-indigo-700",
    progressPercent: "text-indigo-600",
    progressBar: "from-indigo-300 to-indigo-500",
    allDayText: "text-indigo-500 italic",
    divider: "border-indigo-200"
  },
  inProgress: {
    title: "text-amber-900 font-semibold",
    description: "text-gray-700",
    dateLabel: "text-amber-600",
    dateValue: "text-amber-800 font-semibold",
    progressText: "text-amber-700",
    progressPercent: "text-amber-600",
    progressBar: "from-amber-300 to-orange-500",
    allDayText: "text-amber-500 italic",
  ...
  expired: {
    ...
    dateLabel: "text-gray-500",
    dateValue: "text-gray-700 font-semibold",
    progressText: "text-gray-600",
    progressPercent: "text-gray-500",
    progressBar: "from-red-300 to-gray-500",
    allDayText: "text-gray-500 italic",
    divider: "border-gray-300"
  },
  completed: {
    title: "text-emerald-900 font-semibold",
    description: "text-gray-700",
    dateLabel: "text-emerald-600",
    dateValue: "text-emerald-800 font-semibold",
    progressText: "text-emerald-700",
    progressPercent: "text-emerald-600",
    progressBar: "from-emerald-300 to-green-500",
    allDayText: "text-emerald-500 italic",
