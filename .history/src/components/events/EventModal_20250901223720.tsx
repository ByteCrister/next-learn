  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .hide-dialog-close-button button[data-radix-dialog-close] svg,
        .hide-dialog-close-button [data-radix-dialog-close] svg,
        .hide-dialog-close-button [data-radix-dialog-close] button,
        .hide-dialog-close-button [data-radix-dialog-close] button svg {
