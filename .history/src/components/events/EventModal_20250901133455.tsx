        ...
        <DialogContent className="p-0 border-none shadow-none max-h-[90vh]">
          ...
          >
            ...
            <div className={`w-full py-5 px-6 ${gradients.header} rounded-t-2xl`}>
              ...
              >
                {isEdit ? (mode === 'view' ? 'View Event' : 'Edit Event') : 'Create New Event'}
              </DialogTitle>
            </div>
                  ...
                  <Form className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <DatePicker
                        ...
                        onChange={(d) => mode !== 'view' && d && setFieldValue('start', d)}
                        showTimeSelect
                        minDate={new Date()}
                        dateFormat="PPPp"
                        disabled={mode === 'view'}
                    ...
                    <label className="flex items-center space-x-2 text-sm cursor-pointer">
                      <input
                        ...
                        onChange={(e) => mode !== 'view' && setFieldValue('allDay', e.target.checked)}
                        disabled={mode === 'view'}
