...
const contentStatusColors: Record<VEvent['eventStatus'], {
  ...
  upcoming: {
    title: "text-white", // Change title color to white
    description: "text-white", // Change description color to white
    dateLabel: "text-white", // Change date label color to white
    dateValue: "text-white font-semibold", // Change date value color to white
    progressText: "text-white", // Change progress text color to white
    progressPercent: "text-white", // Change progress percent color to white
    progressBar: "from-indigo-300 to-indigo-500", // Softer gradient for progress bar
    allDayText: "text-white italic", // Change all-day text color to white
