...
export const eventPalettes = [
  ...
  {
    id: 'expired',
    gradient: 'bg-gradient-to-br from-red-500 to-slate-700',
    text: 'text-white',
  },
  {
    id: 'completed',
...
const getCardStatusColor = (status: VEvent['eventStatus']): string => {
  const palette = eventPalettes.find(p => p.id === status);
  return palette ? palette.gradient : 'bg-gray-100 text-gray-800';
};
