...
import { Calendar, Clock, Edit, FileText, Plus, RotateCcw, Save, Tag, Trash, CheckCircle, Circle, AlertCircle, MapPin, Users, Bell } from 'lucide-react';
              ...
              <Formik initialValues={defaults} validationSchema={schema} onSubmit={handleSubmit}>
                {({ values, setFieldValue }) => (
                  <Form className="space-y-6">
                    {/* Date/Time Preview */}
                    {values.start && (
                      <div className="p-4 bg-gradient-to-r from-indigo-50 via-blue-50 to-purple-50 dark:from-neutral-800 dark:to-neutral-700 rounded-xl shadow-sm">
