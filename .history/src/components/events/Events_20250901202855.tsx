...
const cardStatusColors: Record<VEvent['eventStatus'], string> = {
  upcoming: "bg-gradient-to-br from-purple-400 to-indigo-600 text-white",
  inProgress: "bg-gradient-to-br from-orange-400 to-yellow-400 text-black",
  expired: "bg-gradient-to-br from-slate-400 to-gray-600 text-white",
  completed: "bg-gradient-to-br from-teal-400 to-green-600 text-white"
};
