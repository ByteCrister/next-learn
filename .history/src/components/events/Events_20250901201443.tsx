                      ...
                      <Card className={`px-0 py-0 rounded-3xl overflow-hidden border border-indigo-100 shadow-md transition-all duration-300 hover:shadow-indigo-hover cursor-pointer ${getCardStatusColor(evt.eventStatus)}`}>
                        ...
                        <div className={`px-0 py-0 rounded-3xl overflow-hidden border border-indigo-100 shadow-md transition-all duration-300 hover:shadow-indigo-hover ${getCardStatusColor(evt.eventStatus)}`}>
                          ...
                          <CardContent className="px-6 pb-6 space-y-5">
                            ...
                            {/* Description */}
                            <p className="line-clamp-3 text-gray-800 leading-relaxed text-sm">
                              {evt.description
                            ...
                            <div className="text-gray-700 text-sm space-y-1">
                              <p>
                                ...
                                <span className="font-semibold text-gray-700">{toDate(evt.start)?.toLocaleString() || '—'}</span>
                              </p>
                              <p>
                                <Clock size={14} className="inline mr-1" />
                              ...
                              {evt.allDay && <p className="text-gray-700 italic text-xs font-semibold">All Day Event</p>}
                              {!evt.allDay && <p className="text-gray-700 italic text-xs font-semibold">Session Event</p>}
                            </div>
                            ...
                            {evt.tasks?.length > 0 && (
                              <div className="space-y-2">
                                <div className="flex items-center justify-between text-xs font-medium text-gray-700">
                                  ...
                                  <span className="text-xs text-gray-700">{Math.round((doneCount / totalCount) * 100)}%</span>
                                </div>
