...
const schema = Yup.object().shape({
  ...
  eventStatus: Yup.string()
    .oneOf(['upcoming', 'inProgress', 'expired', 'completed'], 'Invalid event status')
    .required('Event status is required'),
  currentStatus: Yup.string()
    .oneOf(['upcoming', 'inProgress', 'expired', 'completed'], 'Invalid current status')
                ...
                {({ values, setFieldValue }) => (
                  <Form className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label
                        htmlFor="start"
                        className="flex items-center gap-2 text-sm font-medium w-full border border-neutral-300 dark:border-neutral-700 rounded-lg px-3 py-2 bg-neutral-50 dark:bg-neutral-800"
                      >
