              ...
              : paginatedEvents.length === 0
                ...
                : paginatedEvents.map((evt) => {
                  ...
                  return (
                    ...
                    >
<Card className={`rounded-3xl overflow-hidden border border-indigo-100 shadow-md transition-all duration-300 hover:shadow-indigo-hover ${getCardStatusColor(evt.eventStatus)} text-white`}>
