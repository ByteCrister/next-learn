...
const contentStatusColors: Record<VEvent['eventStatus'], {
  ...
  upcoming: {
    title: "text-indigo-800", // Darker shade for better visibility
    description: "text-gray-800", // Medium gray for readability
    dateLabel: "text-indigo-600", // Lighter shade for contrast
    dateValue: "text-indigo-700 font-semibold", // Slightly darker for emphasis
    progressText: "text-indigo-600", // Color that stands out
    progressPercent: "text-indigo-500", // Color that complements the card
    progressBar: "from-indigo-300 to-indigo-500", // Softer gradient
    allDayText: "text-indigo-400 italic", // Softer tone for all-day events
    divider: "border-indigo-200" // Softer border color
  },
  inProgress: {
