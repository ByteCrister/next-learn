              ...
              : paginatedEvents.length === 0
                ...
                : paginatedEvents.map((evt) => {
                  ...
                  return (
                    ...
                    >
VVVVVVVV<Card className={`rounded-3xl overflow-hidden shadow-md transition-all duration-300 hover:shadow-indigo-hover ${getCardStatusColor(evt.eventStatus)}`}>
