...
export default function EventModal({ initial, isOpen, onClose }: Props) {
  ...
  async function handleSubmit(values: VEvent) {
    ...
    // Create a clean payload with only the essential fields
    const payload: VEvent = {
      ...
      tasks: values.tasks.map(task => ({
        id: task.id || '', // Server will generate ID for new tasks
        title: task.title,
      ...
      // Don't send createdAt/updatedAt for new events - let server handle them
      createdAt: isEdit ? values.createdAt : undefined,
      updatedAt: isEdit ? values.updatedAt : undefined,
    };
