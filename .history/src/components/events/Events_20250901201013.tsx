                          ...
                          <CardContent className="px-6 pb-6 space-y-5">
                            ...
                            <div className="text-gray-900 text-sm space-y-1">
                              <p>
                                ...
                                <span className="font-semibold text-gray-900">{toDate(evt.start)?.toLocaleString() || '—'}</span>
                              </p>
                              <p>
                                <Clock size={14} className="inline mr-1" />
                              ...
                              {evt.allDay && <p className="text-gray-900 italic text-xs font-semibold">All Day Event</p>}
                              {!evt.allDay && <p className="text-gray-900 italic text-xs font-semibold">Session Event</p>}
                            </div>
                            ...
                            {evt.tasks?.length > 0 && (
                              <div className="space-y-2">
                                <div className="flex items-center justify-between text-xs font-medium text-gray-900">
                                  ...
                                  <span className="text-xs text-gray-900">{Math.round((doneCount / totalCount) * 100)}%</span>
                                </div>
