...
import { Calendar, Clock, Edit, FileText, Plus, RotateCcw, Save, Tag, Trash, CheckCircle, Circle, AlertCircle, MapPin, Users, Bell, Eye, X } from 'lucide-react/esm';
              ...
              <div className="relative z-10 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <motion.button
                    ...
                    className="absolute top-4 right-4 p-2 bg-transparent rounded-full hover:bg-white/30 transition-all duration-200 group"
                  >
