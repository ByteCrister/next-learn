        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
             <Link href={`/user-login?callbackUrl=${encodeURIComponent(pathname)}`} className="hidden sm:inline-flex">
                <Button variant="outline" className="hover:bg-purple-100 dark:hover:bg-purple-900 hover:text-purple-700 dark:hover:text-purple-300">
                  Login
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {navLinks.map((link) => (
             ...
             <Link href={`/user-signup?callbackUrl=${encodeURIComponent(pathname)}`} className="w-full mt-2">
               <Button variant="outline" className="w-full hover:bg-purple-100 dark:hover:bg-purple-900 hover:text-purple-700 dark:hover:text-purple-300">
                 Get Started
                 <SparklesIcon className="-me-1 opacity-60" size={16} aria-hidden="true" />
               </Button>
             </Link>
