      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-stone-200" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href={`/user-signup?callbackUrl=${encodeURIComponent(pathname)}`} className="w-full mt-2 text-center items-center justify-center rounded-md text-sm font-medium h-10 px-4 py-2 bg-indigo-700 text-white hover:bg-indigo-800 block transition-colors duration-300">
              Get Started
            </Link>
          </div>
        </div>
