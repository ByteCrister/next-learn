...
import { Twitter, Linkedin, Facebook, AtSign, Instagram, Music2 } from "lucide-react";
...
function Footer() {
  ...
  const socialIcons = [
    ...
    },
    {
      name: "TikTok",
      href: "#",
      svg: <Music2 className="size-6 transition-transform duration-200 hover:scale-110" />,
    },
  ];
