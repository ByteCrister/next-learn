...
const AUTH_PAGES = ["/user-login", "/user-reset-pass", "/features","/about","/how-to-use"]; // your public routes
...
export async function middleware(req: NextRequest) {
    ...
    if (!token && !AUTH_PAGES.includes(req.nextUrl.pathname) && req.nextUrl.pathname !== "/") {
