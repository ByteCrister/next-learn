...
function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  // Since this is a server component, we need to handle this differently
  // For now, we'll show header/footer on all pages except the specified auth routes
  // The actual pathname check will need to be handled in a client component
