...
export default function ViewSharedNotePage({ subjectId, noteId }: { subjectId: string; noteId: string; }) {
    ...
    const load = React.useCallback(async () => {
        ...
        setBreadcrumbs([
            { label: 'Home', href: '/' },
            { label: 'Shared Note', href: `/view-subject/notes/${encodeId(encodeURIComponent(subjectId))}/${encodeId(encodeURIComponent(noteId))}` },
        ]);
    }, [noteId, setBreadcrumbs, subjectId]);
