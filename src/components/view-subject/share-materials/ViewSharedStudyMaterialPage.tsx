...
export default function ViewSharedStudyMaterialPage({ subjectId, studyMaterialId }: { subjectId: string; studyMaterialId: string; }) {
    ...
    const load = React.useCallback(async () => {
        ...
        setBreadcrumbs([
            { label: 'Home', href: '/' },
            { label: 'Shared Study Material', href: `/view-subject/study-material/${encodeId(encodeURIComponent(subjectId))}/${encodeId(encodeURIComponent(studyMaterialId))}` },
        ]);
    }, [setBreadcrumbs, subjectId, studyMaterialId]);
                                                ...
                                                {data.studyMaterial.urls.length === 1 ? (
                                                    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                                        {data.studyMaterial.fileTypes[0] === 'pdf' ? (
                                                            ...
                                                            <Image
                                                                src={data.studyMaterial.urls[0]}
                                                                alt={data.studyMaterial.filename || "Study Material"}
                                                                width={1200}
                                                                height={800}
