...
import { FiClock, FiCalendar, FiType } from "react-icons/fi";
      ...
      <div className="p-4 sm:p-6 flex flex-wrap items-center gap-2 sm:gap-3">
        ...
        >
          ...
          <SelectContent className="rounded-lg">
            <SelectItem value="new" className="flex items-center gap-2 rounded-md text-sm">
              <FiClock className="text-muted-foreground" />
              Newest first
            </SelectItem>

            <SelectItem value="old" className="flex items-center gap-2 rounded-md text-sm">
              <FiCalendar className="text-muted-foreground" />
              Oldest first
            </SelectItem>

            <SelectItem value="name" className="flex items-center gap-2 rounded-md text-sm">
        ...
        >
          ...
          <SelectContent className="rounded-lg">
            <SelectItem value="6" className="flex items-center gap-2 rounded-md text-sm">
              <Grid2X2 className="size-4 text-muted-foreground" />
              Show 6
            </SelectItem>
            <SelectItem value="12" className="flex items-center gap-2 rounded-md text-sm">
              <Grid3X3 className="size-4 text-muted-foreground" />
              Show 12
            </SelectItem>
            <SelectItem value="24" className="flex items-center gap-2 rounded-md text-sm">
